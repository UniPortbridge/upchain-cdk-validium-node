...
type Aggregator struct {
	...
	GenerateProofDelay      types.Duration  //zkbtc
...
func New(
	...
	a := Aggregator{
		...
		GenerateProofDelay:      cfg.GenerateProofDelay, //zkbtc
...
func (a *Aggregator) getAndLockBatchToProve(ctx context.Context, prover proverInterface) (*state.Batch, *state.Proof, error) {
	...
	//zkbtc: check delay for generating proof, if not reaches delay, pretend that we didn't find batch to prove
